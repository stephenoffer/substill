...
bias correction produced m/eps updates of ~10^8x effective LR, a catastrophic
...
def test_embedding_pra_resets_step_and_zeros_state():
    ...
    import substill
    from substill.training.reabsorb import reabsorb_gpt2

    torch.manual_seed(0)
    loader = _make_loader()

    profile = substill.profile(teacher, loader, n_calib_batches=4, behavioral_calib_batches=4)
