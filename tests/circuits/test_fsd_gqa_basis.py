"""Tests for substill.profiling.gqa_basis.
...
demonstrates the shared-basis contribution: it's not just a correctness test,
it's the experimental gate that justifies the mechanism.
"""
...
from substill.profiling.gqa_basis import (
    GQAConfig,
...
def test_shared_basis_beats_disjoint_basis_on_synthetic_gqa():
    """The headline test for the shared per-KV-group basis.
    ...
    This justifies the entire shared-basis fix.
    """
