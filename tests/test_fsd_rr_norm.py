"""Tests for fasd.util.rr_norm.RRNorm and replace_layernorm_with_rrnorm.
...
Key invariants:
  ...
  - Q stays orthogonal under standard PyTorch optimizers only by accident; it
    *will* stay orthogonal under the Stiefel optimizer (Sprint 5). This file
...
from fasd.util.rr_norm import RRNorm, replace_layernorm_with_rrnorm
