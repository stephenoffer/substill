"""fasd's branch engine matches asd's on residual-stream hooks (no branch split).
...
from asd.profiling.activation_capture import ActivationCaptureEngine
from fasd.autodetect import BranchSpec
from fasd.profiling.activation_capture import BranchCaptureEngine
...
def test_fasd_residual_covariance_matches_asd():
    ...
    assert err < 1e-5, f"fasd/asd covariance diverges by {err}"
