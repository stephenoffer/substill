...
Usage:
    python scripts/cpsd/cpsd_cpi_init_eval.py \
        --teacher TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T \
...
from substill.compression.cpi import (
...
def main():
    ...
    profile = substill.profile(teacher, calib, n_calib_batches=args.calib_batches,
    ...
    for variant in variants:
        ...
        results[variant] = {"params": int(sp), "init_ppl": float(init_ppl),
