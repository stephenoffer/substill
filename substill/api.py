...
@dataclass
class DistillResult:
    """Return value from :func:`substill.distill`."""
...
def profile(
    ...
    *,
    ...
    pca_backend
        ...
        / ``"oja"``. See :mod:`substill.profiling.streaming_pca`.
    n_calib_batches
    ...
    for spec in branches:
        ...
        # would need a second pass, which we keep out of the profile
        # (StreamingPCA is independently exposed for users who want
        # to feed it manually). Decode via eigendecomposition
