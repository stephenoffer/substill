...
that one generic interpreter consumes (see :mod:`substill.arch.interpreter`).
...
# Keep in sync with substill.compression.absorbed_init.WeightLayout ("conv2d" added for the
# vision/ResNet path).
