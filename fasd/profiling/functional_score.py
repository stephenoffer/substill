...
Existing behavioral-rank selection (:mod:`fasd.profiling.behavioral_rank`)
...
The allocator (:mod:`fasd.compression.rank_allocator`) consumes ``q`` to
    ...
    *,
    ...
    try:
        for batch in calib_batches:
            ...
            # we just need to call backward on the loss.
